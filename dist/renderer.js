...
class Store {
    ...
    useEvent(event, listener, validate = ()=>true
    ) {
...
var ChangeLog = fromPromise(promise.then(()=>{
    ...
    const buildChangelogItem = function(item1, index) {
        ...
        return(/*#__PURE__*/ React.createElement(React.Fragment, {
            ...
            className: joinClassNames(changelogClasses.title, (_type = ItemTypes[item1.type]) !== null && _type !== void 0 ? _type : ItemTypes.ADDED, [
                index === 0,
                "pc-margin-top-0"
            ])
...
var FontAwesome = ((props)=>{
    ...
    var _className, _spin;
    return(/*#__PURE__*/ React.createElement("span", {
        style: props.color ? {
            color: props.color
        } : null,
        className: joinClassNames(stylePrefix, `fa-${iconName}`, (_className = props.className) !== null && _className !== void 0 ? _className : "", [
            (_spin = props.spin) !== null && _spin !== void 0 ? _spin : false,
            "fa-spin"
        ]).trim()
    }));
});
...
const ColorPicker = fromPromise(Webpack.whenReady.then(()=>{
    try {
        ...
        return (props)=>/*#__PURE__*/ React.createElement(ErrorBoundary, null, /*#__PURE__*/ React.createElement(ColorPicker1, _extends$d({
            }, props)))
        ;
    } catch (error) {
