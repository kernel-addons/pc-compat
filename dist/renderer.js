...
class Patcher {
    ...
    static doPatch(caller, module, functionName, callback, type = "after", options = {
        ...
        const patch = this._patches.find((e)=>e.module === module && e.functionName === functionName
        ) ?? this.pushPatch(caller, module, functionName);
...
const patchAvatars = function() {
    ...
    Patcher.after("pc-utility-classes-animated-avatar", Avatar.AnimatedAvatar, "type", (_, args, res)=>{
        return(/*#__PURE__*/ React.createElement(Avatar.default, _extends$Y({
        }, res.props)));
    });
    const AvatarWrapper = Webpack.findByProps([
        "wrapper",
        "avatar"
    ])?.wrapper?.split(" ")?.[0];
...
const injectAsyncFlux = function() {
    ...
    Flux.connectStoresAsync = function(stores1, factory) {
        return (Component)=>fromPromise(Promise.all(stores1).then((stores)=>{
                return Flux.connectStores(stores, (props)=>factory(stores, props)
                )(Component);
            }))
        ;
    };
    ...
    static emit(event, ...args) {
        ...
        for (const listener of this.events[event]){
            try {
                ...
                Logger$c.error(`Store:${this.constructor.name}`, "Could not fire callback:", error);
            }
        }
    }
}
...
function TextInput(props) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        required: required,
        noteHasMargin: true
    }, /*#__PURE__*/ React.createElement(TextInput1, _extends$X({
    }, props, {
        required: required
    }))));
}
...
function RadioGroup({ children: title , note , required , ...props }) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        note: note,
        required: required
    }, /*#__PURE__*/ React.createElement(RadioGroup1, _extends$W({
    }, props))));
}
...
function SelectInput(props) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        required: required,
        noteHasMargin: true
    }, /*#__PURE__*/ React.createElement(SelectInput1, _extends$V({
    }, props, {
        required: required
    }))));
}
...
const ColorPicker = fromPromise(Webpack.whenReady.then(()=>{
    try {
        ...
        const ColorPicker1 = findInReactTree(rendered, (e)=>e?.props?.defaultColor != null
        ).type;
        if (typeof ColorPicker1 !== "function") throw "ColorPicker could not be found!";
        return (props)=>/*#__PURE__*/ React.createElement(ErrorBoundary, null, /*#__PURE__*/ React.createElement(ColorPicker1, _extends$U({
            }, props)))
        ;
    } catch (error) {
...
const SliderInput = fromPromise(promise.then(()=>{
    ...
    return function SliderInput(props) {
        ...
        return(/*#__PURE__*/ React.createElement(FormItem, {
            ...
            note: note,
            required: required
        }, /*#__PURE__*/ React.createElement(Slider, _extends$T({
        }, Object.assign({
        }, props, {
            className: [
                props.className,
...
function Checkbox({ children: title , note , required , ...props }) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        note: note,
        required: required
    }, /*#__PURE__*/ React.createElement(Checkbox1, _extends$S({
    }, props))));
}
...
var FontAwesome = ((props)=>{
    ...
    const stylePrefix = stylePrefixes[styles.indexOf(style1)] ?? "fas";
    const iconName = props.icon.replace(`-${style1}`, "");
    return(/*#__PURE__*/ React.createElement("span", {
        style: props.color ? {
            color: props.color
        } : null,
        className: joinClassNames(stylePrefix, `fa-${iconName}`, props.className ?? "", [
            props.spin ?? false,
            "fa-spin"
        ]).trim()
    }));
...
function getModuleByDisplayName(displayName, retry, forever) {
    return getModule((m)=>m.displayName?.toLowerCase() === displayName.toLowerCase()
    , retry, forever);
}
...
function DiscordIcon({ name , ...props }) {
    const IconComponent = (cache$4.get(name) ?? (cache$4.set(name, Webpack.findByDisplayName(name)), cache$4.get(name))) ?? (()=>null
    );
    return(/*#__PURE__*/ React.createElement(IconComponent, _extends$g({
    }, props)));
}
...
var ChangeLog = fromPromise(promise.then(()=>{
    ...
    const buildChangelogItem = function(item1, index) {
        return(/*#__PURE__*/ React.createElement(React.Fragment, {
            key: item1.title
        }, /*#__PURE__*/ React.createElement("h1", {
            className: joinClassNames(changelogClasses.title, ItemTypes[item1.type] ?? ItemTypes.ADDED, [
                index === 0,
                "pc-margin-top-0"
            ])
        }, item1.title), /*#__PURE__*/ React.createElement("ul", null, item1.items.map((item)=>/*#__PURE__*/ React.createElement("li", {
                key: item
            }, /*#__PURE__*/ React.createElement(Markdown, null, item))
        ))));
    };
    return function ChangeLog({ items , title , ...props }) {
        return(/*#__PURE__*/ React.createElement(ModalRoot, _extends$f({
        }, props, {
            className: joinClassNames(changelogClasses.container, modalClasses.content)
        }), /*#__PURE__*/ React.createElement(ModalHeader, {
            separator: false
        }, /*#__PURE__*/ React.createElement(Flex.Child, {
            basis: "auto",
            grow: 1,
            shrink: 1,
            wrap: false
        ...
        }, title)), /*#__PURE__*/ React.createElement(Flex.Child, {
            basis: "auto",
            rgrow: 0,
            shrink: 1,
            wrap: false
        ...
        }))), /*#__PURE__*/ React.createElement(ModalContent, null, items.map(buildChangelogItem))));
    };
}));
...
const tabs = new Proxy(settings, {
    has (target, key) {
        return settings.has(key) || target[key] != null;
    },
    ...
    get (target, key1) {
        ...
        if (key1 === "hasOwnProperty") return (key)=>{
            return settings.has(key) || key in settings;
        };
        return settings.get(key1) ?? target[key1];
    }
});
promise.then(()=>{
...
function AddonCard({ addon , manager , openSettings , hasSettings , type  }) {
    ...
    return(/*#__PURE__*/ React.createElement("div", {
        ...
        className: "pc-settings-addon-card " + addon.manifest.name?.replace(/ /g, "-")
    }, /*#__PURE__*/ React.createElement("div", {
        ...
        value: manager.isEnabled?.(addon) ?? false,
        onChange: ()=>{
...
class Clyde {
    static sendMessage(channelId = DiscordModules.SelectedChannelStore.getChannelId(), message) {
        ...
        }, MessageCreators.createBotMessage(channelId, message?.content), DefaultMessage, message));
    }
}
...
Webpack.whenReady.then(()=>{
    ...
    const unpatch = Patcher.after("Commands", ChannelChatMemo, "type", (_, __, returnValue1)=>{
        ...
        Patcher.after("Commands", ChannelChat.prototype, "render", (_, __, returnValue)=>{
            ...
            form?.unshift(React.createElement(CommandBar, {
...
function Notice(props) {
    ...
    if (props.type && types[props.type]) props.icon = {
        ...types[props.type]
    };
    ...
    }, props.icon && typeof props.icon == 'object' ? /*#__PURE__*/ React.createElement(FontAwesome, {
    ...
    }, props.buttons.map((button, i)=>button && /*#__PURE__*/ React.createElement(Button, {
...
function NoticesContainer() {
    ...
    return(/*#__PURE__*/ React.createElement(ErrorBoundary, null, notices.map(([id, notice])=>/*#__PURE__*/ React.createElement(Notice, _extends$c({
            id: id
        }, notice, {
            key: id
        }))
...
var Announcement = fromPromise(promise.then(()=>{
    ...
    return function Announcement(props) {
        ...
        return(/*#__PURE__*/ React.createElement(Notice, {
            color: Colors[props.color?.toUpperCase()] ?? Colors.BLURPLE,
            id: props.id
...
function AnnouncementContainer({ store: useAnnouncements1  }) {
    ...
    return(/*#__PURE__*/ React.createElement(React.Fragment, null, Object.values(elements).map((notice)=>/*#__PURE__*/ React.createElement(Announcement, _extends$b({
        }, notice, {
            key: notice.id
        }))
    )));
...
function UpdaterCard({ hasPendingUpdates , onUpdate  }) {
    ...
    const updaterInfo = DataStore$1.useEvent("updates", ()=>{
        return DataStore$1.tryLoadData("info", defaultInfo);
    }, (name)=>name === "info"
    );
