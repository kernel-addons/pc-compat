...
class WebpackModule {
    ...
    on(event1, callback) {
        if (!(event1 in _classPrivateFieldGet(this, _events))) throw new Error(`Unknown Event: ${event1}`);
        return _classPrivateFieldGet(this, _events)[event1].add(callback), ()=>this.off(event1, callback)
        ;
    }
    off(event2, callback1) {
        if (!(event2 in _classPrivateFieldGet(this, _events))) throw new Error(`Unknown Event: ${event2}`);
...
function Notice(props) {
    ...
    const timeout = React.useMemo(()=>props.timeout || 3000
    , []);
    ...
    }, (_header = props.header) !== null && _header !== void 0 ? _header : "Unknown"), /*#__PURE__*/ React.createElement(Button, {
        look: Button.Looks.BLANK,
        size: Button.Sizes.NONE,
...
function NoticesContainer() {
    ...
    return(/*#__PURE__*/ React.createElement(ErrorBoundary, null, notices.map(([id, notice])=>/*#__PURE__*/ React.createElement(Notice, _extends$Q({
            id: id
        }, notice, {
            key: id
        }))
...
function RadioGroup({ children: title , note , required , ...props }) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        note: note,
        required: required
    }, /*#__PURE__*/ React.createElement(RadioGroup1, _extends$O({
    }, props))));
}
...
function SelectInput(props) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        required: required,
        noteHasMargin: true
    }, /*#__PURE__*/ React.createElement(SelectInput1, _extends$N({
    }, props, {
        required: required
    }))));
}
...
const ColorPicker1 = fromPromise(Webpack.whenReady.then(()=>{
    try {
        ...
        return (props)=>/*#__PURE__*/ React.createElement(ErrorBoundary, null, /*#__PURE__*/ React.createElement(ColorPicker, _extends$M({
            }, props)))
        ;
    } catch (error) {
...
const SliderInput = fromPromise(promise.then(()=>{
    ...
    return function SliderInput(props) {
        ...
        return(/*#__PURE__*/ React.createElement(FormItem, {
            ...
            note: note,
            required: required
        }, /*#__PURE__*/ React.createElement(Slider, _extends$L({
        }, Object.assign({
        }, props, {
            className: [
                props.className,
...
function Checkbox({ children: title , note , required , ...props }) {
    ...
    return(/*#__PURE__*/ React.createElement(FormItem, {
        ...
        note: note,
        required: required
    }, /*#__PURE__*/ React.createElement(Checkbox1, _extends$K({
    }, props))));
}
